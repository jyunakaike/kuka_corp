...
export default {
    FAQList:
        [
            {
                "id": 1,
                "pregunta": "¿Qué es KUKA?",
                "respuesta": "Es un suplemento nutricional a base de extracto de hoja de coca."
            },
            {
                "id": 2,
            ...
            {
                "id": 3,
                "pregunta": "¿Cuántas calorías aporta?",
                "respuesta": "Alrededor de 4 calorias por unidad."
            },
            {
                "id": 4,
            ...
            },
            {
                ...
                "respuesta": " Incrementa la energía, Potencia el rendimiento físico, Mejora el rendimiento mental, Te da lucidez, Mejora el dolor, Ayuda a la digestión, Mejora el estado de animo, Reduce el apetito, Alivia el mal de altura, Potencia el sistema inmune"
            },
            ...
            {
                "id": 9,
                "pregunta": "¿A partir de que edad se recomienda?",
                "respuesta": "A partir de los 16 años."
            },
            {
                "id": 10,
                "pregunta": "¿Qué contraindicaciones tiene?",
                "respuesta": "Arritmias cardíacas, hipersensibilidad a los componentes de la hoja de coca, alergias a la hoja de coca."
            },
            {
                "id": 11,
